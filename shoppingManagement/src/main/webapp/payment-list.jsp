		...
		<div class="row">
			...
			<div class="container">
				...
				<div class="container text-left">
					...
					<a href="Payment-form.jsp" class="btn btn-primary">ADD New
						Payment</a> <input type="text" id="myInput" onkeyup="myFunction()"
						placeholder="Search for payment ID" title="Type in a name">
								...
								<td>
									<div class="btn-group">
										<label class="p-0 mr-1 my-0"> <a
											href="edit?id=<c:out value='${payment.id}' />"><button
													type="submit" class="btn btn-primary">Edit</button></a>
										</label> <label class="p-0 my-0"> <a
											href="delete?id=<c:out value='${payment.id}' />"><button
				...
				<br>
				<br> <a href="<%=request.getContextPath()%>/report">
