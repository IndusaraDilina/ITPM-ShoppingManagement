...
<header>
	...
	function myFunction() {
		...
		while (rs.next()) {
			...
			img.setAttribute("style", "https://i.imgur.com/QpjAiHq.jpg");
			...
			var h61 = document.createElement("h61");
			h61.className = "text-danger";
			h61.innerHTML = "Available Stock: " + <%=qty%>;
			...
			btn1.setAttribute("name", "Details");
